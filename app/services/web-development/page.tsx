                ...
                <div className="mx-auto max-w-7xl">
                    ...
                    <Reveal delay={0.16} y={20}>
                        <p className="mt-8 max-w-3xl text-lg leading-relaxed text-gray-400">
                            We build and refine WordPress and custom-coded
                            websites designed around speed, credibility,
                ...
                <div className="mx-auto grid max-w-7xl gap-12 md:grid-cols-2">
                    <div>
                        ...
                        <Reveal delay={0.08} y={24}>
                            <h2 className="mt-4 text-4xl font-bold md:text-5xl">
                                A website can look polished and still quietly
                                lose customers.
                            </h2>
                        </Reveal>
                    </div>
                    ...
                    <div className="space-y-6 text-lg leading-relaxed text-gray-400">
                        <Reveal delay={0.1} y={20}>
                            <p>
                                Slow pages, unclear messaging, awkward
                                navigation and weak calls to action create doubt
                                at exactly the moment a prospect should be
                                gaining confidence.
                            </p>
                        </Reveal>
                        ...
                        <Reveal delay={0.18} y={20}>
                            <p>
                                Good web development connects design, structure,
                                performance and persuasion so the next step
                                feels obvious.
                            </p>
                        </Reveal>
                    </div>
                    ...
                    <div className="mb-14">
                        ...
                        <Reveal delay={0.08} y={24}>
                            <h2 className="mt-4 max-w-3xl text-4xl font-bold md:text-5xl">
                                The right website for the way your business
                                actually works.
                            </h2>
                        </Reveal>
                    </div>
                        ...
                        <div className="rounded-3xl border border-orange-500/20 bg-white/[0.03] px-8 py-16 text-center md:px-16">
                            ...
                            <Reveal delay={0.08} y={24}>
                                <h2 className="mx-auto mt-5 max-w-4xl text-4xl font-bold md:text-6xl">
                                    Your website should earn trust before anyone
                                    speaks to you.
                                </h2>
                            </Reveal>
                            ...
                            <Reveal delay={0.16} y={20}>
                                <p className="mx-auto mt-6 max-w-2xl text-lg leading-relaxed text-gray-400">
                                    Tell us whether you need a new build, a
                                    redesign or targeted improvements to the
