...
export default function CreativePerformancePage() {
    return (
        <main className="min-h-screen px-8 pb-24 pt-52 text-white">
            <PortfolioSubnav />
            ...
            <section className="mx-auto max-w-7xl">
                ...
                <Reveal delay={0.16} y={20}>
                    <p className="mt-6 max-w-2xl text-lg leading-relaxed text-gray-400">
                        Strategic ad concepts, creative analysis, messaging,
                        hooks, scripts, briefs and paid-growth thinking built
                        around real brands.
                    </p>
                </Reveal>
                ...
                <div className="mt-16 grid gap-6 md:grid-cols-2">
                    {brands.map((brand, index) => (
                        <Reveal
                            ...
                            y={22}
                        >
                            <div className="group h-full rounded-2xl border border-white/10 bg-white/[0.03] p-8 transition duration-300 hover:-translate-y-1 hover:border-orange-500/40 hover:bg-white/[0.05]">
